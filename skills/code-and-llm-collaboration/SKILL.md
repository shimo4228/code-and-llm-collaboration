...
This skill is the "how" counterpart to decision records in the [Agent Knowledge Cycle (AKC)](https://github.com/shimo4228/agent-knowledge-cycle) research line (concept DOI [10.5281/zenodo.19200726](https://doi.org/10.5281/zenodo.19200726)):

- [AKC ADR-0008 Code and LLM Collaboration](https://github.com/shimo4228/agent-knowledge-cycle/blob/main/docs/adr/0008-code-and-llm-collaboration.md) — the "why" behind this catalog
- Pattern 4 underlies [AKC ADR-0004 Two-Stage Distill Pipeline](https://github.com/shimo4228/agent-knowledge-cycle/blob/main/docs/adr/0004-two-stage-distill-pipeline.md)
- Pattern 3 underlies [AKC ADR-0005 Human Approval Gate](https://github.com/shimo4228/agent-knowledge-cycle/blob/main/docs/adr/0005-human-approval-gate.md)
...
Micro-level companion skill: [when-code-when-llm](https://github.com/shimo4228/when-code-when-llm) — the per-task "is this property structural or semantic?" decision. This skill is the per-pipeline layering catalog built on the same axis.
